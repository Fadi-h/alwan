...
class ProductList extends StatelessWidget {
  ...
  _gridBody(context){
    int listLength = productListController.productsList.length;
    return Container(
      width: MediaQuery.of(context).size.width,
    ...
    return GestureDetector(
      onTap: (){
       // productListController.productId.value = productListController.productsList[index].id;
        Get.to(()=>ProductDetails(productListController.productsList[index]));
      },
      child: SizedBox(
        child: Column(
              ...
              child: SizedBox(
                ...
                child: ClipRRect(
                  ...
                  child: Hero(
                    ...
                    tag: productListController.productsList[index],
                    child: Image.network(
                        productListController.productsList[index].image,
                        fit: BoxFit.cover,
